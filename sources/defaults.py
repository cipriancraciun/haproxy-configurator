...
parameters = {
		...
		"backend_server_max_connections_full_count" : parameters_math ("*", parameters_get ("backend_server_max_connections_active_count"), 1, True),
		...
		"backend_server_timeout_activity_server" : parameters_math ("*", parameters_get ("backend_server_timeout_activity"), 1, True),
		"backend_server_timeout_activity_client" : parameters_math ("//", parameters_get ("backend_server_timeout_activity"), 5, True),
		"backend_server_timeout_activity_tunnel" : parameters_math ("*", parameters_get ("backend_server_timeout_activity"), 2, True),
		...
		"backend_server_timeout_queue" : parameters_math ("//", parameters_get ("backend_server_timeout_activity_server"), 2, True),
		...
		"defaults_server_max_connections_full_count" : parameters_math ("*", parameters_get ("defaults_server_max_connections_active_count"), 1),
		...
		"defaults_timeout_activity_server" : parameters_math ("*", parameters_get ("defaults_timeout_activity"), 1, True),
		"defaults_timeout_activity_client" : parameters_math ("//", parameters_get ("defaults_timeout_activity"), 5, True),
		"defaults_timeout_activity_tunnel" : parameters_math ("*", parameters_get ("defaults_timeout_activity"), 2, True),
		...
		"defaults_timeout_queue" : parameters_math ("//", parameters_get ("defaults_timeout_activity_server"), 2, True),
		"defaults_timeout_check" : 6,
		"defaults_timeout_tarpit" : 60,
		"defaults_timeout_request" : parameters_math ("*", parameters_get ("defaults_timeout_activity_client"), 2, True),
		...
		"varnish_max_connections_full_count" : parameters_math ("*", parameters_get ("varnish_max_connections_active_count"), 1, True),
