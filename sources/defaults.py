...
parameters = {
		...
		"backend_server_min_connections_active_count" : parameters_math ("null-if", 0, parameters_math ("//", parameters_get ("backend_server_max_connections_active_count"), 4, True)),
		"backend_server_max_connections_active_count" : None,
		"backend_server_max_connections_queue_count" : parameters_math ("null-if", 0, parameters_math ("*", parameters_get ("backend_server_max_connections_active_count"), 4, True)),
		"backend_server_max_connections_full_count" : parameters_math ("null-if", 0, parameters_math ("*", parameters_get ("backend_server_max_connections_active_count"), 1, True)),
		...
		"backend_server_timeout_activity_server" : parameters_math ("null-if", 0, parameters_math ("*", parameters_get ("backend_server_timeout_activity"), 1, True)),
		"backend_server_timeout_activity_client" : parameters_math ("null-if", 0, parameters_math ("//", parameters_get ("backend_server_timeout_activity"), 5, True)),
		"backend_server_timeout_activity_tunnel" : parameters_math ("null-if", 0, parameters_math ("*", parameters_get ("backend_server_timeout_activity"), 2, True)),
		"backend_server_timeout_connect" : None,
		"backend_server_timeout_fin_server" : parameters_get ("backend_server_timeout_activity_server"),
		"backend_server_timeout_fin_client" : parameters_get ("backend_server_timeout_activity_client"),
		"backend_server_timeout_queue" : parameters_math ("null-if", 0, parameters_math ("//", parameters_get ("backend_server_timeout_activity_server"), 2, True)),
		"backend_server_timeout_check" : None,
		"backend_server_timeout_tarpit" : None,
		"backend_server_timeout_request" : parameters_math ("null-if", 0, parameters_math ("*", parameters_get ("backend_server_timeout_activity_client"), 2, True)),
		...
		"server_min_connections_active_count" : parameters_math ("null-if", 0, parameters_math ("//", parameters_get ("server_max_connections_active_count"), 4, True)),
		"server_max_connections_active_count" : None,
		"server_max_connections_queue_count" : parameters_math ("null-if", 0, parameters_math ("*", parameters_get ("server_max_connections_active_count"), 4, True)),
		...
		"defaults_frontend_max_connections_active_count" : parameters_math ("null-if", 0, parameters_math ("//", parameters_get ("global_max_connections_count"), 2, True)),
		"defaults_frontend_max_connections_backlog_count" : parameters_math ("null-if", 0, parameters_math ("//", parameters_get ("defaults_frontend_max_connections_active_count"), 4, True)),
		"defaults_frontend_max_sessions_rate" : parameters_math ("null-if", 0, parameters_math ("*", parameters_get ("defaults_frontend_max_connections_active_count"), 4, True)),
		
		"defaults_server_min_connections_active_count" : parameters_math ("null-if", 0, parameters_math ("//", parameters_get ("defaults_server_max_connections_active_count"), 4, True)),
		"defaults_server_max_connections_active_count" : 32,
		"defaults_server_max_connections_queue_count" : parameters_math ("null-if", 0, parameters_math ("*", parameters_get ("defaults_server_max_connections_active_count"), 4, True)),
		"defaults_server_max_connections_full_count" : parameters_math ("null-if", 0, parameters_math ("*", parameters_get ("defaults_server_max_connections_active_count"), 1, True)),
		
		"defaults_server_check_interval_normal" : 60,
		"defaults_server_check_interval_rising" : parameters_math ("null-if", 0, parameters_math ("//", parameters_get ("defaults_server_check_interval_normal"), 30, True)),
		"defaults_server_check_interval_failed" : parameters_math ("null-if", 0, parameters_math ("//", parameters_get ("defaults_server_check_interval_normal"), 3, True)),
		...
		"defaults_timeout_activity" : 60,
		"defaults_timeout_activity_server" : parameters_math ("null-if", 0, parameters_math ("*", parameters_get ("defaults_timeout_activity"), 1, True)),
		"defaults_timeout_activity_client" : parameters_math ("null-if", 0, parameters_math ("//", parameters_get ("defaults_timeout_activity"), 5, True)),
		"defaults_timeout_activity_tunnel" : parameters_math ("null-if", 0, parameters_math ("*", parameters_get ("defaults_timeout_activity"), 2, True)),
		"defaults_timeout_connect" : 6,
		"defaults_timeout_fin_server" : parameters_get ("defaults_timeout_activity_server"),
		"defaults_timeout_fin_client" : parameters_get ("defaults_timeout_activity_client"),
		"defaults_timeout_queue" : parameters_math ("null-if", 0, parameters_math ("//", parameters_get ("defaults_timeout_activity_server"), 2, True)),
		"defaults_timeout_check" : 6,
		"defaults_timeout_tarpit" : 60,
		"defaults_timeout_request" : parameters_math ("null-if", 0, parameters_math ("*", parameters_get ("defaults_timeout_activity_client"), 2, True)),
		...
		"global_max_connections_rate" : parameters_math ("null-if", 0, parameters_math ("//", parameters_get ("global_max_connections_count"), 16, True)),
		"global_max_sessions_rate" : parameters_math ("null-if", 0, parameters_math ("*", parameters_get ("global_max_connections_rate"), 4, True)),
		"global_max_tls_connections_count" : parameters_math ("null-if", 0, parameters_math ("//", parameters_get ("global_max_connections_count"), 2, True)),
		"global_max_tls_connections_rate" : parameters_math ("null-if", 0, parameters_math ("//", parameters_get ("global_max_tls_connections_count"), 16, True)),
		"global_max_pipes" : parameters_math ("null-if", 0, parameters_math ("//", parameters_get ("global_max_connections_count"), 2, True)),
		...
		"varnish_min_connections_active_count" : parameters_math ("null-if", 0, parameters_math ("//", parameters_get ("varnish_max_connections_active_count"), 4, True)),
		"varnish_max_connections_active_count" : parameters_math ("null-if", 0, parameters_math ("//", parameters_get ("frontend_max_connections_active_count"), 4, True)),
		"varnish_max_connections_queue_count" : parameters_math ("null-if", 0, parameters_math ("*", parameters_get ("varnish_max_connections_active_count"), 4, True)),
		"varnish_max_connections_full_count" : parameters_math ("null-if", 0, parameters_math ("*", parameters_get ("varnish_max_connections_active_count"), 1, True)),
